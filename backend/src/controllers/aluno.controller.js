...
async function removerFoto(req, res) {
  const aluno = await alunoService.removerFoto(req.equipeId, req.params.id);
  success(res, aluno);
}

module.exports = { list, getById, create, update, excluir, enviarFoto, streamFoto, removerFoto };
