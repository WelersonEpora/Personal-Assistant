...
// docs/adr/0022-radar-atualizacao-profissional.md: voto do personal num item do
// Radar (util | irrelevante | enganoso). Não treina nada - é o sensor de que a
// "fofoqueira" está acertando ou derivando. Um voto por (item, usuário); votar
// de novo atualiza.
module.exports = {
